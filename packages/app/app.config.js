...
const withAndroidReleaseBuildTuning = require("./plugins/with-android-release-build-tuning");
...
export default {
  expo: {
    ...
    extra: {
      ...
      router: {},
      eas: {
        projectId: "d8a48751-a196-408b-85d3-29a0cb1dfac1",
      },
    },
    owner: "misaka7369",
  },
